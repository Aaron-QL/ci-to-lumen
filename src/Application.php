...
use OFashion\CFrame\Routing\Router;
...
class Application extends Container
{
     ...
     * The Router instance.
     *
     * @var \OFashion\CFrame\Routing\Router
     */
    public $router;
    ...
    public function prepareForConsoleCommand($aliases = true)
    {
        ...
        $this->register('OFashion\CFrame\Console\ConsoleServiceProvider');
    }
    ...
    protected function registerContainerAliases()
    {
        $this->aliases = [
            ...
            'OFashion\CFrame\Routing\Router' => 'router',
            'Illuminate\Contracts\Translation\Translator' => 'translator',
            'OFashion\CFrame\Routing\UrlGenerator' => 'url',
