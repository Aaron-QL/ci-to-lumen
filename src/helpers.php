...
use OFashion\CFrame\Bus\PendingDispatch;
...
if (! function_exists('app')) {
     ...
     * @return mixed|\OFashion\CFrame\Application
     */
...
if (! function_exists('redirect')) {
     ...
     * @return \OFashion\CFrame\Http\Redirector|\Illuminate\Http\RedirectResponse
     */
    function redirect($to = null, $status = 302, $headers = [], $secure = null)
    {
        $redirector = new OFashion\CFrame\Http\Redirector(app());
...
if (! function_exists('response')) {
     ...
     * @param  int     $status
     * @param  array   $headers
     * @return \Illuminate\Http\Response|\OFashion\CFrame\Http\ResponseFactory
     */
    function response($content = '', $status = 200, array $headers = [])
    {
        $factory = new OFashion\CFrame\Http\ResponseFactory;
